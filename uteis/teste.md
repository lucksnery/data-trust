...
Se não existe controle formal: seguir para 1.1 a 1.3.
...
Referência legal:
Art. 6º, III — Princípio da necessidade: limitar o tratamento ao mínimo necessário.
...
Se não há políticas de autenticação: seguir 2.1 a 2.3.
Se há, mas são básicas: revisar e fortalecer.
Se são robustas: avançar para etapa 3.
...
Priorizar aplicativos autenticadores (Google Authenticator, Microsoft Authenticator) ou tokens

Referência legal:
Art. 46º — adoção de medidas de segurança técnicas e administrativas.
...
Se não há monitoramento: seguir 3.1 e 3.2.
...
Se não há revisão periódica: seguir 4.1.
...
Se terceiros têm acesso a dados: seguir 5.1 e 5.2.
...
Referência legal:
Art. 39º — o operador deve seguir as instruções do controlador.

6. Existe política formal de controle de acessos?

Sem formalização, o processo não é sustentável.

Se não existe política: seguir 6.1.
...
Se não há treinamento: seguir 7.1.
